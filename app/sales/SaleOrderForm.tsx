...
import { createSaleOrder, updateSaleOrder } from "./actions";
...
export default function SaleOrderForm({
  ...
  const formBody = (
    <form action={isEdit ? updateSaleOrder : createSaleOrder} className="space-y-4 border-t border-gray-100 p-4">
      ...
      <div className="flex justify-end">
        <label className="block w-48">
          ...
          <input
            name="issue_date"
            type="date"
            defaultValue={order?.issue_date ?? today}
            required
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <label className="block">
          ...
          <input name="customer" defaultValue={order?.customer ?? ""} required className={inputClass} />
        </label>
        <label className="block">
          <span className="mb-1 block text-sm font-medium text-gray-700">Brand</span>
          <input name="brand" defaultValue={order?.brand ?? ""} className={inputClass} />
        </label>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <label className="block">
          ...
          <input
            name="shipment_date"
            type="date"
            defaultValue={order?.shipment_date ?? ""}
            className={inputClass}
          />
        </label>
        <label className="block">
          ...
          <input
            name="payment_term"
            defaultValue={order?.payment_term ?? ""}
            placeholder="e.g. 30 days after B/L"
            className={inputClass}
          />
        </label>
      </div>
      ...
      <label className="block sm:w-1/2 sm:pr-2">
        ...
        <input
          ...
          defaultValue={order?.sales_representative ?? ""}
          className={inputClass}
        />
      </label>
      ...
      <label className="block">
        ...
        <textarea
          ...
          rows={2}
          defaultValue={order?.product_description ?? ""}
          className={inputClass}
        />
      </label>
      <label className="block">
        ...
        <textarea
          ...
          rows={2}
          defaultValue={order?.packaging_detail ?? ""}
          className={inputClass}
        />
      </label>
      <label className="block">
        <span className="mb-1 block text-sm font-medium text-gray-700">Remark</span>
        <textarea name="remark" rows={2} defaultValue={order?.remark ?? ""} className={inputClass} />
      </label>
      <label className="block sm:w-1/2 sm:pr-2">
        <span className="mb-1 block text-sm font-medium text-gray-700">Compiled by</span>
        <input name="compiled_by" defaultValue={order?.compiled_by ?? ""} className={inputClass} />
      </label>
